    ...
    if (likeExists) {
        ...
        return res
            ...
            .json(new ApiResponse(
                200,
                "Removed video like successfully!",
                {}
            ))
    }
...
const toggleCommentLike = asyncHandler(async (req, res) => {
    ...
    if (!(commentId && isValidObjectId(commentId))) throw new ApiError(400, "Valid commentId is required!")
...
const toggleTweetLike = asyncHandler(async (req, res) => {
    ...
    if (!(tweetId && isValidObjectId(tweetId))) throw new ApiError(400, "Valid tweetId is required")
